...
namespace CISSAPortal.Controllers
{
    public class CompaniesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Address,AspNetUserId")] Company company)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Address,AspNetUserId")] Company company)
        {
            if (ModelState.IsValid)
            {
